...
/* Sample SURGERIES + SMOKING datasets standing in for LIBNAME PROJECT.
   Column names, types, and the coded RACE/OUTCOME/CONDX/HOSMKG domains match
   what the original Final_Bonanno.sas reads. Merged by PT_ID downstream. */
data SURGERIES;
